...
export const privacyPolicySections = [
  {
    ...
    paragraphs: [
      ...
      `${siteConfig.name} adopta de manera anticipada los principios y estándares de esta ley en sus procesos de contacto, asesoría y seguimiento con usuarios.`,
    ],
  },
  {
    id: "responsable",
  ...
  },
  {
    ...
    list: [
      "Datos de identificación y contacto: nombre, correo electrónico, teléfono y datos de empresa o actividad.",
      "Datos profesionales: rubro, tipo de consulta y antecedentes necesarios para brindar asesoría o seguimiento.",
      "Datos de navegación y uso: dirección IP, tipo de dispositivo, navegador, páginas visitadas, cookies y eventos de interacción.",
      "Datos derivados de formularios de contacto o solicitudes enviadas a través de la plataforma.",
    ],
  },
  {
    id: "finalidades",
    ...
    list: [
      "Responder consultas y brindar asesoría relacionada con protección y servicios para agentes.",
      "Dar seguimiento comercial o de atención cuando usted lo autorice.",
  ...
  },
  {
    ...
    list: [
      ...
      "Partners o proveedores autorizados para dar seguimiento a su solicitud cuando corresponda.",
    ],
    paragraphsAfter: [
...
export function getPrivacyPolicyWhatsAppUrl(phone) {
